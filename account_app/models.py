...
class Driver(models.Model):
    ...
    car_image = models.ImageField(default='', upload_to="driver/cars", blank=True, null=True)
    license_image = models.ImageField(default='', upload_to="driver/licenses", blank=True, null=True)
    ownership_image = models.ImageField(default='', upload_to="driver/ownerships", blank=True, null=True)
...
class Customer(models.Model):
    ...
    logo = models.ImageField(default='', upload_to="customers/logos", blank=True, null=True)
    company_name = models.CharField(max_length=200, null=True, blank=True)
    commercial_record = models.PositiveIntegerField(default=0)
    commercial_record_image = models.ImageField(default='', upload_to="customers/commercials", blank=True, null=True)
    location = models.CharField(max_length=200, null=True, blank=True)
